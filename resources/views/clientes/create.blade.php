...
<body>
  <form class="row g-7 needs-validation" method="POST" novalidate>
    ...
    <div class="modal fade" id="modalCre" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
             ...
             <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" placeholder="Segundo Nombre" class="form-control" id="segundonombre" name="segundonombre" required>
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" placeholder="Segundo Apellido" class="form-control" id="segundoapellido" name="segundoapellido" required>
