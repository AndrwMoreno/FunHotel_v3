...
<body>
    <div class="modal fade" id="VER{{$cliente->id}}" tabindex="-1" role="dialog" aria-labelledby="VermasLabel{{$cliente->id}}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <i class="bi bi-search"></i>
                    <h5 class="modal-title" id="VermasLabel{{$cliente->id}}" style="font-family: Arial, Helvetica, sans-serif;">Datos de {{$cliente->primerNombre}} {{$cliente->primerApellido}}</h5>
